        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3">
              <a href="mailto:hello@ravecamp.org" className="flex items-center gap-3 text-gray-400 hover:text-white transition-colors">
                <Mail className="w-5 h-5" />
                <span>hello@ravecamp.org</span>
              </a>
              <a href="tel:+233123456789" className="flex items-center gap-3 text-gray-400 hover:text-white transition-colors">
          ...
          <div className="flex items-center gap-4">
            {socialLinks.map((social) => (
              <a
                ...
                className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-purple-600 hover:border-purple-600 transition-all duration-300"
              >
